...
function App() {
  ...
  function onEnter(message) {
    ...
    univerAPI.current.getActiveSheet().getRange(`A${messages.length + 1}`).setValue(message);
  }
      ...
      switch (e.data.status) {
        ...
        case "update":
          ...
          setMessages((prev) => {
            ...
            univerAPI.current.getActiveSheet().getRange(`B${messages.length + 1}`).setValue(cloned[cloned.length - 1].content);
            return cloned;
          });
          break;
  ...
  return IS_WEBGPU_AVAILABLE ? (
    <div className="flex flex-col h-screen mx-auto items justify-end text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900">
      <div id="univer" style={{ height: '600px', width: '800px' }} />
